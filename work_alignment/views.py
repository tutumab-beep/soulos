...
def dashboard(request):
    ...
    return render(request, "work_alignment/dashboard.html", context)
...
def edit_entry(request, entry_date=None):
    ...
    return render(request, "work_alignment/edit_entry.html", context)
